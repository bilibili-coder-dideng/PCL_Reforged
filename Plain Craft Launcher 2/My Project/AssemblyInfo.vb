...
<Assembly: AssemblyTitle("Plain Craft Launcher 2 Reforged")>
<Assembly: AssemblyDescription("Minecraft 启动器 (制作：龙腾猫跃) - Reforged 重铸版")>
<Assembly: AssemblyCompany("")>
<Assembly: AssemblyProduct("Plain Craft Launcher 2 Reforged")>
